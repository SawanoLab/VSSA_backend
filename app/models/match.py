...
class Match(Base, TimestampMixin):
    ...
    home_team_id = Column(String(225), ForeignKey('teams.uuid'), nullable=False)
    away_team_id = Column(String(225), ForeignKey('teams.uuid'), nullable=False)
    ...
    home_team = relationship('Teams', foreign_keys=[home_team_id], back_populates='home_matches')
    away_team = relationship('Teams', foreign_keys=[away_team_id], back_populates='away_matches')
